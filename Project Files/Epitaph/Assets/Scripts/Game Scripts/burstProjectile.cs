...
public class burstProjectile : MonoBehaviour {
	...
	void Start () {
		storedCenterOfMass = spawnOrigin.GetComponent<BurstEnemyController> ().centerOfMass; //gets the center of mass from the reference to its originator upon creation, otherwise it would be a non-satic value
	}
