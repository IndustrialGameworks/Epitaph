...
public class Turret : MonoBehaviour
{
	...
	IEnumerator Attack ()
    {
		while (true)
        {
			...
			spawnedProjectile.gameObject.GetComponent<linearTurretProjectile>().spawnOrigin = gameObject; //assigns this enemy instance to the projectile as point of origin
